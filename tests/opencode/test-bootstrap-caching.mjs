...
if (!cometBootstrapText.includes('核心研发工作流入口')) failures.push('期望 Comet bootstrap 将 /comet 定位为 Agent4 核心研发工作流入口');
if (!cometBootstrapText.includes('完整生命周期')) failures.push('期望 Comet bootstrap 说明 /comet 编排完整生命周期');
